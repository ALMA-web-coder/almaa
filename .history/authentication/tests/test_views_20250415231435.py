...
def test_application_view_step_seven_post(logged_in_client, user):
    ...
    form_data = {
        ...
        'reference_1_name': 'Guinevere',
        'reference_1_email': 'ppppt@gmail.com',
        'reference_1_phone_number': '1234567890',
        'reference_2_name': 'Tim',
        'reference_2_email': 'gpppp@gmail.com',
    ...
    # Check response status and print content if it fails
    if response.status_code == 200:
        print(f"Unexpected 200 response received. Response content: {response.content.decode()}")
    assert response.status_code == 302

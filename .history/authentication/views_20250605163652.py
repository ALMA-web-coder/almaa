...
def masters_application(request):
    ...
    if request.method == "POST":
        ...
        contact_and_address_form = ContactAndAddressForm(
            request.POST, 
            instance=application.contacts if application_exists else None
        )
        educational_form = EducationalBackgroundMastersForm(
            request.POST, 
            instance=application.educational if application_exists else None
        )
        ...
        work_experience_form = WorkExperienceForm(
            request.POST, 
            instance=application.work_experiences if application_exists else None
        )
        other_info_form = OtherInfoForm(
            request.POST, 
            instance=application.other if application_exists else None
        )

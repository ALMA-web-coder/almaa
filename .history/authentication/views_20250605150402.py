...
def masters_application(request):
    ...
    if request.method == "POST":
        ...
        if forms_valid:
            ...
            # Handle errors, forms will display validation messages
        ...
        if application_exists:
            ...
            contact_and_address_form = ContactAndAddressForm(instance=getattr(application, 'contacts', None))
            educational_form = EducationalBackgroundMastersForm(instance=getattr(application, 'educational', None))
            document_upload_form = MastersEducationalDocumentForm(instance=getattr(application, 'masters', None))
            work_experience_form = WorkExperienceForm(instance=getattr(application, 'work_experiences', None))

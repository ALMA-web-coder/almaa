...
def masters_application(request):
    ...
    if request.method == "POST":
        ...
        contact_form = ContactAndAddressForm(request.POST, instance=contacts_instance)
        ...
        if application_exists:
            ...
            contact_form = ContactAndAddressForm(instance=contacts_instance)

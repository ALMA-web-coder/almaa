...
class Documents(models.Model):
    ...
    birth_certificate = models.FileField(upload_to='media/', blank=False, null=False)
    id_document = models.FileField(upload_to='media/', blank=False, null=False)
...
class MastersDocuments(models.Model):
    ...
    transcript = models.FileField(upload_to='media/',blank=False)
    degree_certificate = models.FileField (upload_to='media/',blank=False)
    a_level_certificate = models.FileField (upload_to='media/',blank=False)
    o_level_certificate = models.FileField(upload_to='media/',blank=False)
...
class CertificateDocuments(models.Model):
    ...
    a_level_certificate = models.FileField (upload_to='media/',blank=False)
    o_level_certificate = models.FileField(upload_to='media/',blank=False)
    CV = models.FileField(upload_to='media/' ,blank=False)

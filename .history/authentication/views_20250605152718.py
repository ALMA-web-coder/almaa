...
def masters_application(request):
    ...
    if request.method == "POST":
        ...
        # Fetch related instances if application exists
        ...
        if application_exists:
            contacts_qs = getattr(application, 'contacts', None)
            if contacts_qs and contacts_qs.exists():
                contacts_instance = contacts_qs.first()
            ...
            work_qs = getattr(application, 'work_experiences', None)
            if work_qs and work_qs.exists():
                work_experience_instance = work_qs.first()
        ...
        if application_exists:
            ...
            contacts_instance = contact_qs.first() if contact_qs and contact_qs.exists() else None
            ...
            work_qs = getattr(application, 'work_experiences', None)
            work_experience_instance = work_qs.first() if work_qs and work_qs.exists() else None
